...
//  }else if(grade >= 55){    console.log("You get a D...")
//  }else {
...
// let text = "Teddy";
// let unicode = text.charCodeAt(3);
// console.log(unicode)
// Using fromCharCode() - make it readable for us :). You'll see!
// let text = String.fromCharCode(68,117,110,115,116,97,110,116);
// console.log(text)
...
// let text = "Dunstant Kotte Arachchige.";
// let result = text.startsWith("Dunstant");
// console.log(result)

// Now use any variable with endsWith() and return false
let text = "Dunstant Kotte Arachchige.";
let result = text.endsWith("Arachchige");
console.log(result)
